...
public class PromptBuilder {
    ...
    public String replyInstructions(ChatbotCompanyConfig config, Classification classification, String language) {
        ...
        return String.join("\n",
                ...
                "Ask direct service questions. Avoid permission questions, form-letter phrases, 'Could you', 'Would you like to' and 'Koennten Sie'.",
    ...
    public String repairInstructions(ChatbotCompanyConfig config, Classification classification, String language, String issue) {
        return String.join("\n",
                ...
                "Ask directly. Do not start questions with 'Could you', 'Would you like to', 'Koennten Sie' or similar weak phrasing.",
