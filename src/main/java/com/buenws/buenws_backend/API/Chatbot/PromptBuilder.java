...
public class PromptBuilder {
    ...
    public String replyInstructions(ChatbotCompanyConfig config, Classification classification, String language) {
        ...
        return String.join("\n",
                ...
                "Ask direct service questions. Avoid permission questions or form-letter phrases.",
                "Do not use Markdown bullets or bold text in normal chat replies. Only use the plain contact-form template when the lead is ready.",
